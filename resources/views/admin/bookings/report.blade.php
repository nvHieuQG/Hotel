                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    Doanh thu (dịch vụ + phụ phí)</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($serviceRevenue ?? 0, 0, ',', '.') }} VNĐ</div>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Tổng doanh thu (phòng + dịch vụ)</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($grandRevenue ?? (($totalRevenue ?? 0) + ($serviceRevenue ?? 0)), 0, ',', '.') }} VNĐ</div>
                            </div>
                            <div class="col-auto">

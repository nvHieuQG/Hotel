    ...
    <div class="container">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">Số 9 Đường Nguyễn Trãi, Phường Hòa An, Quận Thanh Xuân, Hà Nội, Việt Nam</span></li>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | WD-36_Dự Án Tốt Nghiệp_SU25 - FPT Polytechnic</p>
        </div>
      </div>
    </div>
  </footer>
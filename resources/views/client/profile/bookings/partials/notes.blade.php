                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">
                            ...
                            Ghi chú công khai sẽ hiển thị cho nhân viên và quản lý khách sạn
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="content" id="note_content" class="form-control" rows="4" 
                                  placeholder="Nhập nội dung ghi chú (ví dụ: yêu cầu đặc biệt, thời gian check-in, v.v.)..." required maxlength="1000"></textarea>
                        <div class="form-text">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edit-note-btn', function(e) {
        ...
        editNote(noteId, content, visibility);
    });
});
...
function renderNotes(notes) {
    ...
    notes.forEach(function(note) {
        ...
        const canEdit = note.user_id === {{ auth()->id() }};

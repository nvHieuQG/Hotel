...
Route::prefix('/staff')->name('staff.')->middleware(['auth', 'admin'])->group(function () {
    ...
    // Tour room changes (admin per tour)
    Route::get('tour-bookings/{tourBookingId}/room-changes', [\App\Http\Controllers\Admin\AdminTourRoomChangeController::class, 'index'])->name('tour-bookings.room-changes.index');
    Route::post('tour-room-changes/{id}/approve', [\App\Http\Controllers\Admin\AdminTourRoomChangeController::class, 'approve'])->name('tour-room-changes.approve');
    Route::post('tour-room-changes/{id}/reject', [\App\Http\Controllers\Admin\AdminTourRoomChangeController::class, 'reject'])->name('tour-room-changes.reject');
    Route::post('tour-room-changes/{id}/complete', [\App\Http\Controllers\Admin\AdminTourRoomChangeController::class, 'complete'])->name('tour-room-changes.complete');
